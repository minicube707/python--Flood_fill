...
def bot(wall_grid, rows, run, stop, end, current_node, set_wall, horizontal): 
    ...
    run, stop, current_node, = algorithm(map_path, rows, run, stop, end, current_node, set_wall, horizontal)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_SPACE and start and end:
                    ...
                    run, stop, current_node, = bot(wall_grid, rows, run, stop, end, current_node, set_wall, True)
